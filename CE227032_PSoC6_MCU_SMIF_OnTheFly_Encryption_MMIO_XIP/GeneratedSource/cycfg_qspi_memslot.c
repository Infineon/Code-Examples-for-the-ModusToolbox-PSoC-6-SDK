...
const cy_stc_smif_mem_cmd_t CY15B104QSN_SlaveSlot_2_readCmd =
{
...
const cy_stc_smif_mem_cmd_t CY15B104QSN_SlaveSlot_2_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x06U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t CY15B104QSN_SlaveSlot_2_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x04U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t CY15B104QSN_SlaveSlot_2_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x02U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t CY15B104QSN_SlaveSlot_2_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x05U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_device_cfg_t deviceCfg_CY15B104QSN_SlaveSlot_2 =
{
    ...
    .readCmd = (cy_stc_smif_mem_cmd_t*)&CY15B104QSN_SlaveSlot_2_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = (cy_stc_smif_mem_cmd_t*)&CY15B104QSN_SlaveSlot_2_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = (cy_stc_smif_mem_cmd_t*)&CY15B104QSN_SlaveSlot_2_writeDisCmd,
    ...
    .programCmd = (cy_stc_smif_mem_cmd_t*)&CY15B104QSN_SlaveSlot_2_programCmd,
    /* Specifies the page size for programming. */
    .programSize = 0x400000U,
    ...
    .readStsRegWipCmd = (cy_stc_smif_mem_cmd_t*)&CY15B104QSN_SlaveSlot_2_readStsRegWipCmd,
...
const cy_stc_smif_mem_config_t CY15B104QSN_SlaveSlot_2 =
{
    /* Determines the slot number where the memory device is placed. */
    .slaveSelect = CY_SMIF_SLAVE_SELECT_2,
    /* Flags. */
    .flags = CY_SMIF_FLAG_WR_EN | CY_SMIF_FLAG_CRYPTO_EN | CY_SMIF_FLAG_MEMORY_MAPPED,
    /* The data-line selection options for a slave device. */
    .dataSelect = CY_SMIF_DATA_SEL0,
    /* The base address the memory slave is mapped to in the PSoC memory map.
    Valid when the memory-mapped mode is enabled. */
    .baseAddress = 0x18020000U,
    ...
    .deviceCfg = (cy_stc_smif_mem_device_cfg_t*)&deviceCfg_CY15B104QSN_SlaveSlot_2
};

const cy_stc_smif_mem_config_t* const smifMemConfigs[] = {
   &CY15B104QSN_SlaveSlot_2
};
