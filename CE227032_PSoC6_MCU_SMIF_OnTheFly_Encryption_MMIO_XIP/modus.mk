...
#
CY_EXAMPLE_NAME = CE227032_PSoC6_MCU_SMIF_OnTheFly_Encryption_MMIO_XIP

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example demonstrates on-the-fly encryption of data using Serial Memory Interface(SMIF) in MMIO and XIP modes. This example uses the CY15B104QSN Excelon™-Ultra 4-Mbit (512K × 8) Quad SPI F-RAM in SPI mode.
...
#
CY_VALID_DEVICES = CY8C6247BZI-D54
...
CYCONFIG_GENERATED_SOURCES = \
	...
	GeneratedSource/qspi_config.cfg
#
