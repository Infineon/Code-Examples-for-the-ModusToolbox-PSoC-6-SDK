...
#
CY_EXAMPLE_NAME = CE219656_UARTLowLevelDMA

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates the UART transmit and receive operation using DMA.
...
#
ifeq ($(DEVICE),CY8C624ABZI-D44)
	CY_VALID_DEVICES = CY8C624ABZI-D44
else
...
#
ifeq ($(DEVICE),CY8C624ABZI-D44)
	CYCONFIG_DESIGN_MODUS = WiFiProto_Kit_modus.modus
else
	CYCONFIG_DESIGN_MODUS = BLE_WifiBT_Kit_modus.modus
endif
