...
#define CY_CAPSENSE_PIN_COUNT (8u)
    ...
    .gestureConfig = {
        {
            .resolutionX = 100u,
            .resolutionY = 300u,
            .gestureEnableMask = 0x80,
            .flickTimeoutMax = 10000u,
            .edgeTimeoutMax = 2000u,
            .clickTimeoutMax = 500u,
            .clickTimeoutMin = 0u,
            .secondClickIntervalMax = 1000u,
            .secondClickIntervalMin = 500u,
            .zoomDistanceMin = 50u,
            .flickDistanceMin = 5u,
            .scrollDistanceMin = 5u,
            .rotateDistanceMin = 50u,
            .edgeDistanceMin = 200u,
            .secondClickDistanceMax = 100u,
            .clickDistanceMax = 200u,
            .zoomDebounce = 3u,
            .scrollDebounce = 3u,
            .rotateDebounce = 10u,
            .edgeAngleMax = 45u,
