...
* CapSense Configurator 1.1.0 build 261
*
********************************************************************************
...
typedef struct {
    ...
    cy_stc_capsense_gesture_config_t gestureConfig[1];
...
<Configuration major="1" minor="1">
    ...
    <CsdProperties>
        ...
        <Property id="CSD_MOD_CLK_DIVIDER" value="4"/>
    ...
    <CsxProperties>
        <Property id="CSX_MOD_CLK_DIVIDER" value="4"/>
    ...
    <Widgets>
        <Widget id="Button0" type="CSX_BUTTON">
            <WidgetProperties>
                ...
                <Property id="SNS_CLK_FREQ" value="1125"/>
                <Property id="ROW_SNS_CLK" value="16"/>
                <Property id="ROW_SNS_CLK_FREQ" value="1125"/>
                <Property id="SNS_CLK_SOURCE" value="AUTO"/>
                <Property id="TX_CLK" value="80"/>
                <Property id="TX_CLK_FREQ" value="225"/>
                ...
                <Property id="FINGER_TH" value="160"/>
                <Property id="PROX_TOUCH_TH" value="200"/>
                <Property id="NOISE_TH" value="80"/>
                <Property id="NNOISE_TH" value="80"/>
                <Property id="LOW_BSLN_RST" value="40"/>
                <Property id="HYSTERESIS" value="20"/>
                <Property id="ON_DEBOUNCE" value="1"/>
            ...
            <Electrodes>
                ...
                <Electrode id="Tx" kind="Row">
                    <ElectrodeProperties>
                        ...
                        <Property id="IDAC1" value="32"/>
                        <Property id="IDAC2" value="32"/>
                        <Property id="PINS" value="Button0_Tx"/>
                    </ElectrodeProperties>
                </Electrode>
            </Electrodes>
        </Widget>
        <Widget id="LinearSlider0" type="LINEAR_SLIDER">
            <WidgetProperties>
                ...
                <Property id="MAX_POS_Y" value="300"/>
                <Property id="FINGER_CP" value="0.2"/>
                <Property id="SNS_CLK" value="16"/>
                ...
                <Property id="SPEED_TH_Y" value="4"/>
                <Property id="BALLISTIC_MULT" value="false"/>
                <Property id="GESTURE_ENABLE" value="true"/>
                <Property id="GESTURE_1F_SINGLE_CLICK_ENABLE" value="false"/>
                <Property id="GESTURE_1F_DOUBLE_CLICK_ENABLE" value="false"/>
                <Property id="GESTURE_1F_CLICK_DRAG_ENABLE" value="false"/>
                <Property id="GESTURE_2F_SINGLE_CLICK_ENABLE" value="false"/>
                <Property id="GESTURE_1F_SCROLL_ENABLE" value="false"/>
                <Property id="GESTURE_2F_SCROLL_ENABLE" value="false"/>
                <Property id="GESTURE_1F_EDGE_SWIPE_ENABLE" value="false"/>
                <Property id="GESTURE_1F_FLICK_ENABLE" value="true"/>
                <Property id="GESTURE_1F_ROTATE_ENABLE" value="false"/>
                <Property id="GESTURE_2F_ZOOM_ENABLE" value="false"/>
                <Property id="GESTURE_FILTERING_ENABLE" value="true"/>
                <Property id="CLICK_TIMEOUT_MAX" value="500"/>
                <Property id="CLICK_TIMEOUT_MIN" value="0"/>
                <Property id="CLICK_DISTANCE_MAX" value="200"/>
                <Property id="SECOND_CLICK_INTERVAL_MAX" value="1000"/>
                <Property id="SECOND_CLICK_INTERVAL_MIN" value="500"/>
                <Property id="SECOND_CLICK_DISTANCE_MAX" value="100"/>
                <Property id="SCROLL_DEBOUNCE" value="3"/>
                <Property id="SCROLL_DISTANCE_MIN" value="5"/>
                <Property id="ROTATE_DEBOUNCE" value="10"/>
                <Property id="ROTATE_DISTANCE_MIN" value="50"/>
                <Property id="ZOOM_DEBOUNCE" value="3"/>
                <Property id="ZOOM_DISTANCE_MIN" value="50"/>
                <Property id="FLICK_TIMEOUT_MAX" value="10000"/>
                <Property id="FLICK_DISTANCE_MIN" value="5"/>
                <Property id="EDGE_EDGE_SIZE" value="200"/>
                <Property id="EDGE_DISTANCE_MIN" value="200"/>
                <Property id="EDGE_TIMEOUT_MAX" value="2000"/>
                <Property id="EDGE_ANGLE_MAX" value="45"/>
