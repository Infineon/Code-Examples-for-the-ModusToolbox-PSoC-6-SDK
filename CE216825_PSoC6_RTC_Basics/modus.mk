...
#
CY_EXAMPLE_NAME = CE216825_PSoC6_RTC_Basics

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = Demonstrates how to read and write the current time using the RTC resource. The UART interface is used to input user data and print the result on the terminal.
