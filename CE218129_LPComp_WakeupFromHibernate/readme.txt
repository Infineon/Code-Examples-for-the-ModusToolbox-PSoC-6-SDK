-------------------------------------------------------------------------------
CE218129_LPComp_WakeupFromHibernate
-------------------------------------------------------------------------------
...
Overview
--------
This code example demonstrates wakeup from the Hibernate mode using the LPComp
Component in PSoC®6 MCU, using ModusToolbox™ IDE.
