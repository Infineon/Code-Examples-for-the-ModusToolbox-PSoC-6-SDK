-------------------------------------------------------------------------------
CE220465_PSoC_6_MCU_CryptoAESDemo
-------------------------------------------------------------------------------
...
Overview
--------
This code example encrypts and decrypts user input data using the AES algorithm
using a 128-bit long key. The encrypted and decrypted data are displayed on a
