...
#
CY_EXAMPLE_NAME = CE220465_CryptoAESDemo

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example demonstrates encryption and decryption of data using the Advanced Encryption Scheme (AES) algorithm in PSoC 6 MCU.
...
CY_MAINAPP_SWCOMP_USED= \
    psoc6sw-1.0/components/psoc6pdl/drivers/library/crypto_softfp \
