...
#
CY_EXAMPLE_NAME = CE220291_PSoC6_TCPWM_Square_Wave

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example generates a square wave using the TCPWM resource configured as PWM. An LED connected to the PWM output pin blinks at 2 Hz.
