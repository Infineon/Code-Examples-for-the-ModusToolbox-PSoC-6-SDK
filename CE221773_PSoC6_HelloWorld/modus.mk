...
#
CY_EXAMPLE_NAME = CE221773_PSoC6_HelloWorld

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates UART communication and blinks an LED using a TCPWM resource, on the PSoC 6 MCU, using ModusToolbox IDE.
