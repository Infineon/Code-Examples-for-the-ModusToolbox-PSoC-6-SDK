...
#
CY_EXAMPLE_NAME = CE224285_PSoC6_QSPI_XIP

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example shows how to execute functions and use variables stored in external memory in XIP mode using QSPI (SMIF).
