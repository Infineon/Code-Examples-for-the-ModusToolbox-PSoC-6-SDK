...
#
CY_EXAMPLE_NAME = CE218541_PSoC6_FaultHandling

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates the fault handling functionality of PSoC 6 MCU and how to add a custom fault handling function to find the fault location. The UART interface will be used for showing ARM register information.
