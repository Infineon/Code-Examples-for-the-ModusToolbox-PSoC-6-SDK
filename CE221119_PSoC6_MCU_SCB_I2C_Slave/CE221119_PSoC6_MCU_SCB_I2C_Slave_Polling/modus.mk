...
#
CY_EXAMPLE_NAME = CE221119_PSoC6_MCU_SCB_I2C_Slave_Polling

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates the operation of the PSoC 6 MCU Serial Control Block (SCB) in I2C Slave mode. This example implements the I2C Slave using polling method.
