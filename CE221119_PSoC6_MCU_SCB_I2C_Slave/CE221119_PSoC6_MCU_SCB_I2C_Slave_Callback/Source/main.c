...
*     (SCB mode) using callback method. The I2C slave accepts a packet from
...
int main(void)
{
    ...
    Cy_SCB_I2C_RegisterEventCallback(KIT_I2C_HW, (cy_cb_scb_i2c_handle_events_t) HandleEventsSlave, &KIT_I2C_context);
