...
#
CY_EXAMPLE_NAME = CE220498_PSoC6_MCWDT

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates Multi-Counter Watchdog Timer (MCWDT) in free running mode on PSoC® 6 MCU. In the example, MCWDT is used to measure the time between two successive switch press events and the result is displayed on the UART terminal. 
