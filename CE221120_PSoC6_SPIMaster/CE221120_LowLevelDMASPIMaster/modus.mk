...
#
CY_EXAMPLE_NAME = CE221120_LowLevelDMASPIMaster

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example project demonstrates SPI communication between two SCB blocks of PSoC 6 device (one configured as Master and another as slave). DMA is used to trasfer data into SCB buffers.
