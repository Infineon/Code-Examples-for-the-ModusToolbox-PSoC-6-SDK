...
#
CY_EXAMPLE_NAME = CE221120_LowLevelUserIsrSPIMaster

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example project demonstrates SPI communication between two SCB blocks of PSoC 6 device (one configured as Master and another as slave). Master uses interrupt method to check the status of data transfer.
