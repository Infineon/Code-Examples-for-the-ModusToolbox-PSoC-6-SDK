...
#
CY_EXAMPLE_NAME = CE221120_LowLevelPollingSPIMaster

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example project demonstrates SPI communication between two SCB blocks of PSoC 6 device (one configured as Master and another as slave). Polling method is used on the master side to confirm data transfer completion.
