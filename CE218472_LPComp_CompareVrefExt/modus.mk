...
#
CY_EXAMPLE_NAME = CE218472_LPComp_CompareVrefExt

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example demonstrates how to set the Low-Power Comparator for comparing the internal reference voltage and external voltage.
