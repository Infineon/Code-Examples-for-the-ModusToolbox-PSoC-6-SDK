-------------------------------------------------------------------------------
CE218472_LPComp_CompareVrefExt
-------------------------------------------------------------------------------
...
Overview
--------
This example demonstrates the voltage comparison functionality using the LPComp
 resource in PSoC® 6 MCU, using ModusToolboxTM IDE.
