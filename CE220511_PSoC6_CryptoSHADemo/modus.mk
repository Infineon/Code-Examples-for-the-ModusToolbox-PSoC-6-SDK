...
#
CY_EXAMPLE_NAME = CE220511_PSoC_6_MCU_CryptoSHADemo

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This code example demonstrates generating a unique hash value or message digest for an arbitrary message using Secure Hash Algorithm (SHA) in PSoC 6 MCU
