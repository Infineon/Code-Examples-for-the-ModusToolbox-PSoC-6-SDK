...
#
CY_EXAMPLE_NAME = CE220818_I2CMasterEzI2CSlave

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example project demonstrates the basic operation of the I2C master with EzI2C slave. The I2C master SCB sends a command packet to the EzI2C slave SCB to control an user LED.
#
