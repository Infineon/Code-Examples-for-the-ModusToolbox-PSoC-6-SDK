...
#
CY_EXAMPLE_NAME = CE220818_I2CMasterLowLevel

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example project demonstrates the basic operation of the I2C master using low level APIs. The I2C master SCB sends a command packet to the I2C slave SCB to control an user LED.
#
