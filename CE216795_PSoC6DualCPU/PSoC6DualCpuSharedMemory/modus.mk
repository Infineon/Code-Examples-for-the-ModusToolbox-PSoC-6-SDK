...
#
CY_EXAMPLE_NAME = PSoC6DualCpuSharedMemory

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example uses the inter-processor communication (IPC) block in PSoC 6. Using the IPC, the CPUs share a portion of SRAM and communicate in a simple mutex/semaphore-based application.
...
CY_APP_CM0P_SOURCE = \
    Source_cm0p/main.c \
    Source_cm0p/ce216795_common.h \
    Source_cm0p/ce216795_common.c
...
CY_APP_CM4_SOURCE = \
	Source/main.c \
    Source/ce216795_common.h \
    Source/ce216795_common.c \
    readme.txt
