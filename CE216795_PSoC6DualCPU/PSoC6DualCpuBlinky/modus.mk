...
#
CY_EXAMPLE_NAME = PSoC6DualCpuBlinky

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example shows the two CPUs in PSoC 6 MCU doing independent tasks. The tasks are simple; each task blinks a separate LED using a firmware delay.
