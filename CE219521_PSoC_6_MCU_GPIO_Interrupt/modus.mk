...
#
CY_EXAMPLE_NAME = CE219521_PSoC_6_MCU_GPIO_Interrupt

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates how to configure a GPIO to generate an interrupt in PSoC® 6 MCU using ModusToolbox™ IDE.
