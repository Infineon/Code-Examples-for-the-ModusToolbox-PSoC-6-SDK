...
#
CY_EXAMPLE_NAME = CE220060_PSoC6_WatchdogTimer

#
# Description of the example project to display
#
CY_EXAMPLE_DESCRIPTION = This example demonstrates Watchdog Timer (WDT) on the PSoC® 6 MCU. Two use cases of WDT are demonstrated - as a watchdog causing device reset in the case of a malfunction and as a periodic interrupt source. 
